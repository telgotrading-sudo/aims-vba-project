...
' ReconcileWorkbooks
' Compares investec monthly.xlsm column C against the investec sheet in companies.xlsm column A
...
Sub Step02MarkDiff()
    ...
    Set wbMonthly = Workbooks("investec monthly.xlsm")
    ...
    Set wsCompanies = wbCompanies.Sheets("investec")
